...
if False:
    ...
    #    +",share=csce/biology/groups/pilizota/Leonardo_Castorina/"
    #    + "RDM_TunnelSlide_Slide2_2_Compilled")
    folderValidate = "/home/s1033855/Desktop/DarkFields_31_01_19/CorrectedHighDensityCells"
    outputModelsFolder = "Files/Models/TempModels"
...
trainingAnswers = [i > 0 for i in trainingAnswers]
...
while epochs>0:
    M1.trainModel(batch_size=5,num_epochs=epochs)
